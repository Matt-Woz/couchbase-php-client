...
// If we have a versioned extension, we need to alias the exceptions to their original namespace
...
zend_register_class_alias("Couchbase\\Exception\\UnambiguousTimeoutException", unambiguous_timeout_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\AmbiguousTimeoutException", ambiguous_timeout_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\AuthenticationFailureException", authentication_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\BucketExistsException", bucket_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\BucketNotFlushableException", bucket_not_flushable_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\BucketNotFoundException", bucket_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\CasMismatchException", cas_mismatch_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\CollectionExistsException", collection_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\CollectionNotFoundException", collection_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\CompilationFailureException", compilation_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ConsistencyMismatchException", consistency_mismatch_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DatasetExistsException", dataset_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DatasetNotFoundException", dataset_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DataverseExistsException", dataverse_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DataverseNotFoundException", dataverse_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DecodingFailureException", decoding_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DeltaInvalidException", delta_invalid_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DesignDocumentNotFoundException", design_document_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DocumentExistsException", document_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DocumentIrretrievableException", document_irretrievable_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DocumentLockedException", document_locked_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DocumentNotFoundException", document_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DocumentNotLockedException", document_not_locked_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DocumentNotJsonException", document_not_json_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DurabilityAmbiguousException", durability_ambiguous_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DurabilityImpossibleException", durability_impossible_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DurabilityLevelNotAvailableException", durability_level_not_available_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\DurableWriteInProgressException", durable_write_in_progress_exception_ce);
...
zend_register_class_alias("Couchbase\\Exception\\EncodingFailureException", encoding_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\FeatureNotAvailableException", feature_not_available_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\GroupNotFoundException", group_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\IndexExistsException", index_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\IndexFailureException", index_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\IndexNotFoundException", index_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\IndexNotReadyException", index_not_ready_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\InternalServerFailureException", internal_server_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\InvalidArgumentException", invalid_argument_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\JobQueueFullException", job_queue_full_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\LinkExistsException", link_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\LinkNotFoundException", link_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\NumberTooBigException", number_too_big_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ParsingFailureException", parsing_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PathExistsException", path_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PathInvalidException", path_invalid_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PathMismatchException", path_mismatch_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PathNotFoundException", path_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PathTooBigException", path_too_big_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PathTooDeepException", path_too_deep_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PermissionDeniedException", permission_denied_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PlanningFailureException", planning_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\PreparedStatementFailureException", prepared_statement_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\RequestCanceledException", request_canceled_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ScopeExistsException", scope_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ScopeNotFoundException", scope_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ServiceNotAvailableException", service_not_available_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\TemporaryFailureException", temporary_failure_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\UnsupportedOperationException", unsupported_operation_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\UserExistsException", user_exists_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\UserNotFoundException", user_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ValueInvalidException", value_invalid_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ValueTooDeepException", value_too_deep_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ValueTooLargeException", value_too_large_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\ViewNotFoundException", view_not_found_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\XattrCannotModifyVirtualAttributeException", xattr_cannot_modify_virtual_attribute_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\XattrInvalidKeyComboException", xattr_invalid_key_combo_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\XattrUnknownMacroException", xattr_unknown_macro_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\XattrUnknownVirtualAttributeException", xattr_unknown_virtual_attribute_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\TransactionException", transaction_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\TransactionOperationFailedException", transaction_operation_failed_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\TransactionFailedException", transaction_failed_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\TransactionExpiredException", transaction_expired_exception_ce);
zend_register_class_alias("Couchbase\\Exception\\TransactionCommitAmbiguousException", transaction_commit_ambiguous_exception_ce);
#endif
}
