...
class SearchOptions implements JsonSerializable
{
     ...
     *
     * @throws InvalidArgumentException if scoring() has already been set: both write the same
     *   field, so they cannot be used together.
     */
    public function disableScoring(bool $disabled): SearchOptions
    {
        if ($this->scoring !== null) {
            throw new InvalidArgumentException("disableScoring() cannot be used together with scoring()");
        }
     ...
     *
     * @throws InvalidArgumentException if disableScoring() has already been set: both write the
     *   same field, so they cannot be used together.
     */
    public function scoring(SearchScoring $scoring): SearchOptions
    {
        if ($this->disableScoring !== null) {
            throw new InvalidArgumentException("scoring() cannot be used together with disableScoring()");
        }
